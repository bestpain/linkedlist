// C program to create a simple linked list with 3 nodes,nodes are added at the beginning.
#include<stdio.h>
#include<stdlib.h>
struct node
{
...
//step 2:we have linked all the nodes together,new nodes are added at beginning.
node3->next=node2;
node2->next=node1;
